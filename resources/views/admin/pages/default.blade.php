            ...
            <div class="row row-sm">
                ...
                <div class="col-lg-6 mg-t-30">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="3" class="form-control @error('meta_keyword') is-invalid @enderror" name="meta_keyword">{!! old('meta_keyword', $page->meta_description) !!}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="3" class="form-control @error('meta_description') is-invalid @enderror" name="meta_description">{!! old('meta_description', $page->meta_keyword) !!}</textarea>
