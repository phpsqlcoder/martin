                                ...
                                <tr>
                                    ...
                                    <td>
                                        <nav class="nav table-options justify-content-end">
                                            @if($user->is_active == 1 && auth()->user()->has_access_to_route('users.edit'))
                                            ...
                                            @if(auth()->user()->has_access_to_route('users.activate') || auth()->user()->has_access_to_route('users.deactivate'))
                                                @if($user->is_active == 1 && auth()->user()->has_access_to_route('users.deactivate'))
                                                ...
                                                @elseif ($user->is_active == 0 && auth()->user()->has_access_to_route('users.activate'))
